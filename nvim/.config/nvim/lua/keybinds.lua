...
vim.api.nvim_set_keymap("n", "<leader>a", "<CMD>AvanteFocus<CR>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<leader>at", "<CMD>AvanteToggle<CR>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<leader>aa", "<CMD>AvanteAsk<CR>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<leader>ac", "<CMD>AvanteChat<CR>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<leader>ae", "<CMD>AvanteEdit<CR>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<leader>an", "<CMD>AvanteChatNew<CR>", { noremap = true, silent = true })
